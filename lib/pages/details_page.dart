...
import 'package:ebook/widgets/rounded_buton.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ChapterCard(
                        name: "Influence",
                        chapterNumber: 3,
                        tag: "Influences easily like  before",
                      ),
                      ChapterCard(
                        name: "Win",
                        chapterNumber: 4,
                ...
                children: [
                  ...
                  RichText(text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: "Like....",style: TextStyle(fontWeight: FontWeight.bold))
                    ]
                  ),
                  ),
                  SizedBox(height: 20,),
                     Stack(
                       children: [
                         ...
                         Positioned(
                           ...
                           height: 170,
                           width: double.infinity,
                           decoration: BoxDecoration(borderRadius: BorderRadius.circular(30),color: Color(0xFFFFF8F)
                           ),
                             child: Column(
                               crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                 RichText(text: TextSpan( 
                                   ...
                                   children: [
                                     ...
                                     TextSpan(text: "Gary Venchuck",style: TextStyle(color: kLightBlackColor))
                                   ]
                                 )
                                 ),
                                 Row(
                                   children: [
                                     ...
                                     SizedBox(height: 20,),
                                     Expanded(child: RoundedButtons(text: "Read",verticalPadding: 5,))
                                   ],
                                 )
                               ],
                             ),
                ...
                Expanded(
                  child: Stack(
                    children: [
                      ...
                      // RoundedButtons(text: "Read",verticalPadding: 10,),
                    ],
                  ),
                ),
